...
class SalaryCalculateService implements SalaryCalculateUseCase {
	...
	public PayStub calculateSalary(SalaryCalculateCommand salaryCalculateCommand) {
		...
		WorkContract workContract = getWorkContractQuery.getWorkContract(employee.getWorkContractId());

		//employeeId와 searchMonth 연결 방법 고려..
		//?? AttendanceRecord attendanceRecord = getAttendanceRecordQuery.getAttendanceRecord(employeeId,searchMonth);
		AttendanceRecord attendanceRecord = getAttendanceRecordQuery.getAttendanceRecord(null);
